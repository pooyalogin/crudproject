...
--
-- Host: localhost:3306
-- Generation Time: Oct 09, 2016 at 09:41 PM
...
CREATE TABLE IF NOT EXISTS clients (
  clientsID int(11) NOT NULL AUTO_INCREMENT COMMENT 'Primary key',
  ...
  KEY fk_Clients_Zip (zip_code_zip_id)
...
CREATE TABLE IF NOT EXISTS projects (
  ...
  PRIMARY KEY (projectID,`clients_clientsID`),
  UNIQUE KEY ProjectID_UNIQUE (projectID),
  KEY fk_Projects_Clients1_idx (clients_clientsID)
...
CREATE TABLE IF NOT EXISTS projects_resources (
  ...
  PRIMARY KEY (projects_projectID,`resources_resourceID`),
  KEY fk_Projects_has_Resources_Resources1_idx (resources_resourceID),
  KEY fk_Projects_has_Resources_Projects_idx (projects_projectID)
...
CREATE TABLE IF NOT EXISTS resources (
  ...
  KEY fk_Resources_Resource (resource_type_res_type_code)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=10 ;
